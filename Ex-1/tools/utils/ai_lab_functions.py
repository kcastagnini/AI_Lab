...
def check_sol(path):
    student_sol = np.array(path)
    solution = np.array([(0, 0), (1, 0), (2, 0), (2, 1), (3, 1), (4, 1), (5, 1), (6, 1), (6, 0), (7, 0), (8, 0), (8, 1), (8, 2), (8, 3), (9, 3), (9, 4), (9, 5), (9, 6), (9, 7)])

    if not np.all(student_sol == solution):
